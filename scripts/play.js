    ...
    for (var i = 0; i < num_rows; i++) {
        ...
        for (var j = 0; j < num_columns; j++) {
            ...
            if (count < images) {
                ...
                $tdImg.attr('src', '/assets/images/' + reverso);
                $tdImg.attr('class', 'cardImg images-fluid');
...
function contdownSecondClick(first_id, currentId) {
    ...
    setTimeout(function() {
        ...
        var card = $(first_id);
        card.attr('src', '/assets/images/' + reverso);
        var current = $(currentId);
        current.attr('src', '/assets/images/' + reverso);
...
function setInit() {
    ...
    $(".cardImg").attr('src', '/assets/images/' + reverso);
    $("#points").html(0);
    $("#total").html(0);
    $("#time").html(time);
